...
DescriptionDate  Date of the strike
...
Civilians_Min/MaxCivilian    death range 
Total_Died_Min/MaxTotal       death range
...
PresidentPeriodGeorge BushBefore Jan 20, 2009Barack ObamaJan 20, 2009 – Jan 20, 2017Donald TrumpJan 20, 2017 – Jan 20, 2021
sqlSELECT tenure, SUM(No_Of_Strike) AS Total_Strikes
FROM droneattacks
GROUP BY tenure;
...
Create a new schema: CREATE SCHEMA sql_store;
Import your raw CSV into a table named droneattacks
Run DroneAttackProject.sql from top to bottom
